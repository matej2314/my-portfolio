...
router.get('/all', (req, res) => {
  ...
  const querySkills = `SELECT 'skills' AS source, s.id, s.skill_name AS title, s.skill_cat AS category, s.icon_name AS icon, s.icon_color AS iconColor, s.icon_set AS iconSet FROM skills s;`;
