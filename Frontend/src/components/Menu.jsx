        ...
        <menu className={`${compClasses.menu.menu} z-20`}>
            <nav>
                <ul className={compClasses.menu.ul}>
                    ...
                    >
                        <a
                            className={`${compClasses.menu.link} relative`}
                        >
                            <AnimatePresence mode="wait" initial={false}>
                                ...
                                {hoveredItem === 'download' && (
                                    <motion.div
                                        ...
                                        className="w-fit h-fit bg-neutral-900/85 absolute left-[5rem] top-[-1.5rem] flex justify-center items-center p-3 z-10 rounded-tr-md rounded-br-md"
                                    >
