...
const BarChart = ({ width, height, data }) => {
    const margin = { top: 35, right: 0, bottom: 0, left: 20 }; // Zwiększamy lewy margines, aby było miejsce na etykiety osi Y
    ...
    return (
        <svg width={width} height={height}>
            ...
            <AxisLeft
                scale={yScale}
                tickFormat={value => value.toFixed(0)}  // Zaokrąglenie wartości na osi Y
