export const projectsClasses = {
    ...
    project: {
        wrapper: "w-full z-0 flex flex-row justify-center",
        ul: "w-full flex flex-col justify-between gap-14 md:grid md:grid-cols-2 md:gap-9 pl-2 overflow-scroll no-scrollbar z-0",
        li: "relative w-full flex flex-row justify-center",
        projectImage: "max-w-80 max-h-72 rounded-md",
        hoverContent: "absolute w-[93%] h-full justify-self-center bottom-0 left-0 right-0 text-white flex flex-col justify-end items-center md:absolute md:w-full md:h-full md:text-base",
