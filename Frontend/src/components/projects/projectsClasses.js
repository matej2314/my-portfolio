export const projectsClasses = {
        ...
        project: {
            ...
            hoverContent: "absolute w-full md:w-[93%] justify-self-center bottom-0 left-0 right-0 text-white flex flex-col justify-end items-center md:absolute md:w-full md:text-base",
