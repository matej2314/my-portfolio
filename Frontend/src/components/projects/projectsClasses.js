export const projectsClasses = {
        ...
        project: {
            ...
            hoverContent: "absolute w-full h-80 w-fit justify-self-center bottom-0 left-0 right-0 text-white flex flex-col justify-end items-center indirect:absolute indirect:w-full sm:absolute sm:w-full md:absolute md:w-full md:h-80 md:text-base",
            contentWrapper: "absolute w-full bg-black/80 flex flex-col justify-center items-center p-1 gap-1 md:w-80 md:flex-col md:pl-4 md:gap-1",
