export const projectsClasses = {
    projects: {
        ...
        ul: "relative w-full h-full md:h-full gap-3 md:gap-8 flex flex-col justify-between xl:grid xl:grid-cols-2 xl:gap-x-5 xl:gap-y-12 pl-2 overflow-scroll no-scrollbar z-0",
    },
    project: {
        li: "w-full max-h-72 md:h-80 relative perspective-1000",
